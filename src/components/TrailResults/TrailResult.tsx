...
export default function SearchResult({
  ...
  return (
    <div className="relative">
      <div
        className="p-4 bg-[#ffffff] rounded-2xl"
        style={{
        ...
        <div className={cn(classNames.flexBetween, "gap-3 mb-6 ")}>
          ...
          <div className="w-full">
            ...
            <div className={cn("flex items-baseline", "gap-1")}>
              ...
              {candidate.companyDetails &&
              candidate.companyDetails.start_date ? (
                <p className="text-[#323130] text-sm font-medium">
      ...
      {/* Registration Button Overlay - Only shown when blurred */}
      {isBlur && (
        <div className="absolute inset-0 flex items-center justify-center z-10">
          <div
            className="flex flex-col justify-center items-center border-radius-[100px]  cursor-pointer"
            style={{
              width: "189px",
              borderRadius: "100px",
              background:
                "linear-gradient(112deg, #263BC7 -8.09%, #483FC5 9.02%, #864CEF 44.29%, #327FFF 72.08%, #005B97 97.74%)",
            }}
